...
- **Settings menu** — color theme (shared with the mesh viewer), terminal shell, session restore, LLM assistant provider/keys, and cloud accounts, persisted across runs.
