...
- **Settings menu** — color theme (shared with the mesh viewer), terminal shell, session restore, LLM assistant provider/keys/tool-approval, and cloud accounts, persisted across runs.
